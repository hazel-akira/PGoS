  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-10 tracking-wide text-[#FFC300]">Life in Abundance</h2>
        ...
        <div className="flex justify-left">
          <button className="border border-[#FFC300] text-[#FFC300] rounded px-6 py-2 font-medium hover:bg-[#FFC300] hover:text-white transition-all">
