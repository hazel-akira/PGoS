...
const AboutSection = () => {
  ...
  return (
    <section className="relative bg-[#f2f2f2] py-4 md:py-12 overflow-x-hidden dark:bg-gray-900">
     <div className="mt-24 flex flex-col items-center text-center px-4">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-5xl font-semibold font-serif tracking-wide text-[#0E013d] whitespace-nowrap dark:text-gray-200">
