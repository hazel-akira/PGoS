      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-0 relative z-10 pt-24 md:pt-40">
        ...
        <div className="relative flex flex-col items-center w-full md:w-auto md:ml-28">
          <div className="bg-white text-[#02032d] p-6 md:p-12 max-w-md w-full shadow-lg text-center">
            ...
            <div className="text-[#FFC300] text-2xl md:text-4xl font-normal leading-tight mb-4">
          ...
          <span className="inline-flex items-center justify-center w-40 h-12 bg-[#FFC300] rounded-r-full font-semibold text-white cursor-pointer transition hover:bg-[#D3AF37] shadow-[-8px_8px_20px_0_rgba(0,0,0,0.15)] -mt-6 md:-mt-6 mx-auto">
            Core &amp; Culture
          </span>
        </div>
        ...
        <div className="flex-1 flex justify-center md:justify-start relative w-full max-w-xl md:mr-15 mt-8 md:mt-0">
          {/* Accent border */}
          <div className="absolute -top-2 -right-2 w-full h-full p-1 rounded-lg bg-gradient-to-br from-[#0E013d] to-[#FFC300] z-0"></div>
          <img
          ...
          />
          {/* Circular Badge */}
          <div className="absolute -top-4 -right-4 sm:-top-6 sm:-right-6 md:-top-10 md:-right-10 bg-gradient-to-br from-[#0E013d] via-[#1E2A60] to-[#FFC300] text-white flex items-center justify-center rounded-full shadow-lg w-16 h-16 sm:w-20 sm:h-20 md:w-32 md:h-32 z-20 p-2">
