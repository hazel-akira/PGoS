...
const MissionVission: React.FC = () => {
  ...
  return (
    <section className="bg-[#f1f2fc] dark:bg-slate-900  mx-auto md:h-screen md:py-16 py-10 bg-fixed">
       <div className=" overflow-hidden">
            
            <div className=" mx-auto px-4 text-center">
                <div className="max-w-4xl mx-auto">
                <hr className="border-t border-gray-300 mb-6 mx-24 md:mx-60 dark:border-[#f4b24a] mt-16 md:mt-0" />
                <h1 className="text-xl md:text-5xl font-bold font-serif dark:text-[#f4b24a] text-[#02032d] mb-2">About Us</h1>
                <p className="text-lg text-gray-600 dark:text-white pt-10"><span className="text-orange-400">"</span>Discover our commitment to educational excellence <span className="text-orange-400">"</span></p>
                    
                </div>
            </div>
        </div>
        <div className="mx-4 md:mx-auto my-32 md:p-10 dark:bg-gray-800  p-6 space-y-20 border-t-0 shadow-lg rounded-xl text-gray-800 max-w-6xl">
        {/* Mission Section */}
        <div>
            ...
            <div>
            <p className="text-md sm:text-base dark:text-white font-sans">
        ...
        <div>
            ...
            <div>
            <p className="text-md dark:text-white sm:text-base">
