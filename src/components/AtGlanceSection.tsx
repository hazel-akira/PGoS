  ...
  return (
    <section className="relative bg-[#ECECFB] py-28 px-4">
      <div className="max-w-6xl mx-auto text-center relative">
        ...
        <button className="mt-20 bg-[#FFC300] hover:bg-[#D3AF37] text-white px-6 py-3  font-semibold rounded shadow-md transition-all text-base md:text-lg" style={{boxShadow: '2px 2px 0 #8884'}}>
          MORE FACTS
        </button>
      </div>
    </section>
