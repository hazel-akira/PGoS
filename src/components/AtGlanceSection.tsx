  ...
  return (
    <section className="relative bg-gradient-to-br from-[#02032d] via-slate-900 to-[#02032d] py-28 px-4">
      <div className="max-w-6xl mx-auto text-center relative">
        ...
        <button className="md:mt-32 mt-20 md bg-[#F4B24A] hover:bg-[#e68a00] text-white px-6 py-3 rounded  transition font-semibold rounded shadow-md transition-all text-md md:text-lg" style={{boxShadow: '2px 2px 0 #8884'}}
