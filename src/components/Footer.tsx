    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-semibold mb-4">PGOS School</h3>
            <p className="text-gray-400 mb-4">Empowering students with knowledge, innovation, and excellence since 1995.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Lunch Menu</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">123 School Avenue, Education City, ST 12345</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">info@pgosschool.edu</span>
              </li>
            </ul>
          </div>
        </div>
