...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0E013D] text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">Empowering students with knowledge, innovation, and excellence since 1995.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">School Calendar</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Lunch Menu</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin className="h-5 w-5 mr-2 text-indigo-300 mt-0.5" />
                <span className="text-gray-300">123 School Avenue, Education City, ST 12345</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">info@pgosschool.edu</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 text-center text-gray-300">
          <p>&copy; {currentYear} PGOS School. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
