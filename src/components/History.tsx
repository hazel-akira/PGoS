     ...
     <div className="relative w-full">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="bg-[#02032d] text-white p-6 md:p-10 flex flex-col justify-center items-center w-full md:w-1/2">
            <h2 className="text-2xl font-bold text-center tracking-wide font-serif text-orange-400 md:my-0 my-4">Heritage to Horizon</h2>
            <p className="text-sm md:text-base max-w-xl border border-white/20 border-t-0 shadow-inner rounded-b-xl  p-6 backdrop-blur-sm">
