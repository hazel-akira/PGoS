...
const VisitUsFormAndTour: React.FC = () => {
  ...
  return (
    ...
    <div className="bg-[#f1f1f1] w-auto h-auto py-10 px-2 sm:px-4 md:px-8">
<hr className="border-t  border-gray-300 mb-6 mx-30" />
<motion.h2
 initial={{ opacity: 0, x: -50 }}
 whileInView={{ opacity: 1, x: 0 }}
 transition={{ duration: 0.6 }}
  className="text-3xl md:text-5xl font-semibold font-serif text-[#02032d] text-center mb-20 tracking-wide"
>
...
<div className="flex items-start justify-center mb-6 max-w-2xl mx-auto">
  ...
  <p className="text-gray-600 text-2xl text-left">
    <span className="text-[#02032d] font-semibold">
      Are you interested in experiencing life as an Eagle?
    </span>
  </p>
</div>

          <h3 className='text-[#02032d]'>We'd be thrilled to give you a tour of our PGOS community!</h3>
        </p> 
<hr className="border-t w-20  border-orange-500 h-6 mx-auto" />
  ...
  transition={{ duration: 0.6 }}
  viewport={{ once: true }}
  className="bg-white rounded-xl shadow pt-8 p-4 sm:p-6 mb-8 sm:mb-12 w-full max-w-2xl mx-auto lg:max-w-4xl xl:max-w-5xl"
>
...
>
  <div className="w-full text-[#02032d] text-lg mb-4 md:mb-0"> 
    ...
    <h2 className="text-3xl md:text-5xl font-semibold font-serif text-[#02032d] text-center mb-20 tracking-wide">
      Take a Virtual Tour
    </h2>
    <p className="mb-2 text-left text-2xl md:text-center">
