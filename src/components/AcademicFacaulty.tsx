    ...
    <section className='w-full h-screen bg-[#f7f7f7] py-16 px-4 text-[#02032d]'>
      <div className='flex flex-col items-center justify-center'>
        <div className='text-center px-4'>
          ...
          <span className="w-8 md:w-24 h-px bg-orange-300"/>
          <h2 className='text-xl md:text-2xl font-semi-bold italic mb-8 text-[#02032d]'>Next</h2>
          ...
          <button className='shadow-lg px-8 py-3 font-bold italic text-xl bg-gradient-to-r from-[#0E013d] to-orange-300 z-10 rounded-full text-white'>Explore Admissions</button>
        </div>
        {/* statistics cards */}
