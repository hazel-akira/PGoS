...
const HeroAcademics: React.FC = () => {
    ...
    return(
      <section className="relative bg-[#f2f2f2] bg-cover bg-center bg-fixed h-[80vh] text-white flex flex-col items-center justify-center" style={{ backgroundImage: "url('/images/academicbanner.png')" }}>
