    ...
    <section className="bg-[#f1f2fc] py-16 text-center">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center">
          <h2 className="text-3xl font-bold text-orange-500 mb-8 mt-10 text-center">LEADERSHIP</h2>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="flex items-center justify-center mb-6 mt-2"> 
          <span className="w-8 md:w-24 h-px bg-orange-300"/>
            <h2 className="text-2xl font-bold text-orange-500 px-2">BOARD OF TRUSTEES</h2>
          <span className="w-8 md:w-24 h-px bg-orange-300"/>
        </div>
